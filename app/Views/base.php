...
<body>
    ...
    <nav class="navbar sticky-top flex-md-nowrap p-0">
        <a class="navbar-brand col-sm-3 col-md-2 mr-0" href="<?php echo base_url(); ?>">Koha xTra Tools</a>

        <ul class="navbar-nav px-3">
            <li class="nav-item text-nowrap">
                <a class="nav-link d-inline" href="/"> <span class="fa fa-home"></span> Koha | </a>
                <a class="nav-link d-inline" href="<?php echo base_url(); ?>/index.php/home/logout/">
                    Welcome, <?php if(session()->has('userid')){ echo session()->get('userid'); } ?> | Logout
                </a>
            </li>
        </ul>
    </nav>
